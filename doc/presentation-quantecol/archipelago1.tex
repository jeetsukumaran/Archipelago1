...
\begin{tabular}{l|c|c|}
			...
			& $\mu=0.0$ & $\mu=0.1$ \\
\hline			
``Box''		& \includegraphics[scale=0.15]{box-d0.pdf}		  &  \includegraphics[scale=0.15]{box-d1.pdf}  	\\
\hline
``Linear''	& \includegraphics[scale=0.15]{linear-d0.pdf}		  & \includegraphics[scale=0.15]{linear-d1.pdf} 		\\
